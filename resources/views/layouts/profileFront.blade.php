                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul class="navbar-nav ml-auto">
                            @guest
                                ...
                                @endif
                            @else
                                <li><a class="nav-link" href="{{ action('Admin\NewsController@index') }}" method="get" style="color:black">{{ __('messages.News') }}</a></li>
                                <li><a class="nav-link" href="{{ action('Admin\ProfileController@index') }}" method="get" style="color:black">{{ __('messages.Profile') }}</a></li>
