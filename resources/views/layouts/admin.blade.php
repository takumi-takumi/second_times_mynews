                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul class="navbar-nav ml-auto">
                            @guest
                                <li><a class="nav-link" href="{{ action('NewsController@index') }}" method="get">{{ __('messages.News') }}</a></li>
                                <li><a class="nav-link" href="{{ action('ProfileController@index') }}" method="get">{{ __('messages.Profile') }}</a></li>
